...
// API Setup
const API_KEY = "AIzaSyACsQXV7BZ18Mu10Up8IQ73a8Hsmp4L0A4";
...
// Handle ENTER to send (desktop only)
...
// Dynamic border-radius on input height
...
document.querySelector(".chat-footer").appendChild(emojiPickerWrapper);
...
emojiPickerWrapper.style.display = "none"; // Hide initially
